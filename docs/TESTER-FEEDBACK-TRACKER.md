...
- **Status:** FIXED on develop, staged in 2026.07.14.3. **Owner action:** verify on `https://testfalamadeira.searchingfool.com` (sign out → sign back in → should land in-app, no onboarding, no Terms re-ask), then approve prod promotion.
