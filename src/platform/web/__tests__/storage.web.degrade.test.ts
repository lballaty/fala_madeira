// File: src/platform/web/__tests__/storage.web.degrade.test.ts
...
//
//   NOTE: this suite lives in its OWN file (not storage.web.test.ts) because it vi.mock('idb') to
//   force openDB to reject — a module-hoisted mock that would poison the EN-8 pinned-store tests in
//   storage.web.test.ts, which need REAL fake-indexeddb to exercise the v2->v3 upgrade. Merge of
//   feat/en8 + EN-27 (2026-07-17): the two add/add suites were kept in separate files.
